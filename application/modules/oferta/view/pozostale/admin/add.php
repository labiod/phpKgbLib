...
?>
<form action="/oferta/admin/confirm/submodule/pozostale" method="post"
	name="oferta" enctype="multipart/form-data">
	<table id="tab_edit" cellspacing="0">
		...
		<tr>
			...
			<td class="right"><input id="pozostale" type="file" class="oneTime"
				name="file" size="100" />
				<div id="up_pozostale" class="uploadImg"></div></td>
		</tr>
		<tr>
