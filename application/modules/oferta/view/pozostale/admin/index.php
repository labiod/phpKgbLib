...
?>
<div id="dodaj">
	<a id="add_button" href="/oferta/admin/add/submodule/pozostale"><img
		class="icon" src="/public/images/add.png" alt="Dodaj produkt"
		title="Dodaj produkt" /> Dodaj produkt</a>
</div>
...
if (! $this->pozostale->isNull ()) {
	...
	foreach ( $this->pozostale as $p ) {
		...
		<td><a
			href="/oferta/admin/edit/submodule/pozostale/id/<?php echo $p['id_pozostale']; ?>"><img
				class="icon" src="/public/images/modify_m.png" alt="edytuj"
				title="edutyj" /> edytuj</a> <a
			href="/oferta/admin/delete/submodule/pozostale/id/<?php echo $p['id_pozostale']; ?>"
			name="potwierdz" id="<?php echo $p['nazwa_pozostale']; ?>"><img
	...
	?>
		...
		<td colspan="6"
			...
			nie ma pozostałych produktów.</td>
	</tr>
		<?php
}
?>					
