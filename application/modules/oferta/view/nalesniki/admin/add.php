...
<form name="oferta" action="/oferta/admin/confirm/submodule/nalesniki"
	...
	<table id="tab_edit" cellspacing="0">
		...
		<tr>
			...
			<td class="right"><input type="file" id="nalesniki" name="file"
				class="oneTime" size="100" />
				<div id="up_nalesnika" class="uploadImg"></div></td>
		</tr>
		<tr>
