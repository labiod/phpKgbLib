...
?>
<form name="oferta" action="/oferta/admin/confirm/submodule/nalesniki"
	...
	<table id="tab_edit" cellspacing="0">
		...
		<tr>
			<td class="left">Nazwa naleśnika:</td>
			<td class="right"><input class="itext" type="text"
				id="nazwa_nalesnika" name="nazwa_nalesnika"
				value="<?php echo $nalesniki[0]['nazwa_nalesnika']; ?>" /></td>
		</tr>
		<tr>
			<td class="left">Cena:</td>
			<td class="right"><input class="itext_short" type="text" id="cena"
				name="cena" value="<?php echo $nalesniki[0]['cena']; ?>" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="right"><input
				<?php if($nalesniki[0]['zdjecie_url'] != "") echo "style='display:none;'"; ?>
				type="file" id="nalesniki" name="file" class="oneTime" size="100" />
				<div id="up_nalesnika" class="uploadImg">
						<?php if($nalesniki[0]['zdjecie_url'] != "") { ?>
							<div id="ch_nalesnika_0" class="upImage">
						<a
							href="/data/nalesniki/<?php echo $nalesniki[0]['zdjecie_url'];?>"><img
							src="/data/nalesniki/m_<?php echo $nalesniki[0]['zdjecie_url'];?>"
							alt="foto" /></a> <input id='nalesnika_0' type='button'
		...
		<tr>
			<td colspan="2" class="cntr"><a
				href="/oferta/admin/index/submodule/nalesniki"><input type="button"
					id="redirect" name="redirect" class="button" value="Wróć" /></a> <input
				type="submit" id="submit" name="submit" class="button"
				value="Edytuj" /> <input type="hidden" name="id_nalesnik"
				value="<?php echo $nalesniki[0]['id_nalesnik']; ?>" />
