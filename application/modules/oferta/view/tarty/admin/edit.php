...
?>
		...
		<input type="hidden" name="id" value="<?php echo $tarta['id_tarty']; ?>" />
			<table id="tab_edit" cellspacing="0">
				...
				<tr>
					...
					<td class="right"><input type="text" name="nazwa_tarty" class="itext" value="<?php echo $tarta['nazwa_tarty'];?>" /></td>
				</tr>
				<tr>
					<td class="left">Typ :</td>
					<td class="right" id="td_typ"><input type="radio" name="typ" value="slona" class="iradio" <?php if($tarta['typ']=='slona') echo "checked"; ?> /> słona 
									  <input type="radio" name="typ" value="slodka" class="iradio" <?php if($tarta['typ']=='slodka') echo "checked"; ?> /> słodka
									  <input type="radio" name="typ" value="wykwintna" class="iradio" <?php if($tarta['typ']=='wykwintna') echo "checked"; ?> /> wykwintna
					</td>
				</tr>
				
				<tr id="tr_rodzaj" <?php if($tarta['typ']!='slona') echo "style='display: none'"; ?> >
					<td class="left">Rodzaj :</td>
					<td class="right"><input type="radio" name="rodzaj" value="wdl" class="iradio" <?php if($tarta['rodzaj']=='wdl') echo "checked"; ?>/> z wędliną
									  <input type="radio" name="rodzaj" value="k" class="iradio" <?php if($tarta['rodzaj']=='k') echo "checked"; ?>/> z kurczakiem
									  <input type="radio" name="rodzaj" value="r" class="iradio" <?php if($tarta['rodzaj']=='r') echo "checked"; ?>/> z rybą
									  <input type="radio" name="rodzaj" value="weg" class="iradio" <?php if($tarta['rodzaj']=='weg') echo "checked"; ?>/> wegetariańska 
					</td>
				</tr>
				<tr>
						...
						<?php 
							if((!$this->ceny->isNull())){
								...
								foreach($ceny as $c){ ?>
									<tr>
										<td>
											<input type="radio" name="ceny_id" value="<?php echo $c['id_grupa_cenowa']; ?>" class="iradio" <?php if($tarta['ceny_id']==$c['id_grupa_cenowa']) echo "checked"; ?> />
										</td>
				...
				<tr>
					...
					<td class="right"><input type="checkbox" name="dostepna" class="iradio"  <?php if($tarta['dostepna']==1) echo "checked"; ?> /> dostępna</td>
				</tr>
				<tr><td class="left">Zdjęcie :</td>
					<td class="right"><input id="tarty" type="file" name="file" style="<?php if(isset($tarta['zdjecie_url'])) echo "display: none;"; ?>" class="oneTime" size="100" />
						<div id="up_tarty" class="uploadImg" >
							<?php if(isset($tarta['zdjecie_url'])){
							?>
							<div id="ch_tarty_0" class="upImage">
								<a href="/data/tarty/<?php echo $tarta['zdjecie_url']; ?>" class="galeria"><img src="/data/tarty/m_<?php echo $tarta['zdjecie_url'];?>" alt="foto" /></a>
								<input id='tarty_0' type='button' style='margin-top: 5px;' class='remover button' value='Usuń' />
							</div>
							<?php 
							}?>
						</div>
