	...
	<table id="tab_edit" cellspacing="0">
		...
		<tr>
			...
			<td class="right" id="td_typ"><input type="radio" name="typ"
				value="slona" class="iradio" checked /> słona <input type="radio"
				name="typ" value="slodka" class="iradio" /> słodka <input
		...
		<tr id="tr_rodzaj">
			...
			<td class="right"><input type="radio" name="rodzaj" value="wdl"
				class="iradio" /> z wędliną <input type="radio" name="rodzaj"
				value="k" class="iradio" /> z kurczakiem <input type="radio"
				name="rodzaj" value="r" class="iradio" /> z rybą <input type="radio"
				name="rodzaj" value="weg" class="iradio" /> wegetariańska</td>
		</tr>
		<tr>
			...
			<td><?php echo $skladnik["nazwa_skladnika"]; ?>: <input
				type="checkbox" id="s_<?php echo $skladnik["skladnika_id"]; ?>"
				name="sklad[]" value="<?php echo $skladnik["id_skladnika"]; ?>" /></td><?php
						...
						?>	
				     <a href="/oferta/admin/add/submodule/skladniki" id="showPopup">Dodaj
				składnik</a>
			</td>
		</tr>
		<tr>
				...
				<table>
					<tr>
						...
						<td><input type="radio" name="ceny_id"
							value="<?php echo $c['id_grupa_cenowa']; ?>" class="iradio" /></td>
		...
		<tr>
			...
			<td class="right"><input type="checkbox" name="dostepna"
				class="iradio" checked /> dostępna</td>
		</tr>
		<tr>
			<td class="left">Zdjęcie :</td>
			<td class="right"><input type="file" id="tarty" name="file"
				class="oneTime" size="100" />
				<div id="up_tarty" class="uploadImg"></div></td>
		</tr>
		<tr>
