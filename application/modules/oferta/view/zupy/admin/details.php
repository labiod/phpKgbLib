...
?>
	<table id="tab_edit" cellspacing="0">
				...
				<tr>
					<td class="left">Nazwa zupy:</td><td class="right"><?php echo $zupy[0]['nazwa_zupy']; ?></td>
				</tr>
				<tr>
					<td class="left">Cena mała:</td><td class="right"><?php echo $zupy[0]['cena_mala']; ?></td>
				</tr>
				<tr>
					<td class="left">Cena duża:</td><td class="right"><?php echo $zupy[0]['cena_duza']; ?></td>
				</tr>
				<tr>
