...
?>
<div id="dodaj">
	<a id="add_button" href="/oferta/admin/add/submodule/zupy"><img
		class="icon" src="/public/images/add.png" alt="Dodaj zupę"
		title="Dodaj zupę" /> Dodaj zupę</a>
</div>
...
if ($this->zupy != null && $this->zupy->count () != 0) {
	...
	foreach ( $zupy as $zupa ) {
		...
		<td><a
			href="/oferta/admin/details/submodule/zupy/id/<?php echo $zupa['id_zupa']; ?>"><img
				class="icon" src="/public/images/info_m.png" alt="szczegóły"
				title="szczegóły" /> szczegóły</a> <a
			href="/oferta/admin/edit/submodule/zupy/id/<?php echo $zupa['id_zupa']; ?>"><img
				class="icon" src="/public/images/modify_m.png" alt="edytuj"
				title="edutyj" /> edytuj</a> <a
			href="/oferta/admin/delete/submodule/zupy/id/<?php echo $zupa['id_zupa']; ?>"
