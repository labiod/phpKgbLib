	...
	public function addmailAction() {
		if ($this->getMethod () == "POST") {
			...
			if ($id == 0) {
				...
				$text = "------------------------------------------------------------------------<br/>" . " &#34;O tartach  oraz o ich ojczyznach : Francji i Belgii&#34;<br/>" . "------------------------------------------------------------------------<br/>" . "<p>Witaj Drogi Czytelniku,</p>
		 ...
		 <p>-------------------------------------------------------------------------------------------------------<br/>" . "Jeśeli zechcesz się wypisać z grona czytelników, wystarczy :  <br/>" . "<a href='" . $_SERVER ['SERVER_NAME'] . "/newsletter/delete/id/" . $id . "'>kliknąć tutaj</a></p>";
