...
<script type="text/javascript" >
    ...
    <div id="ddialog" style="display: none;" title="Wyslij testowego maila">
        <form action="/newsletter/admin/confirm" method="post" id="sendTestMail">
			<table id="tab_edit" cellspacing="0" style="width: 400px; margin: 0 auto;">
				<tr>
					<th colspan="2">Utwórz nowy biuletyn</th>		
				</tr>
				<tr>
					<td class="left">Testowy mail:</td><td class="right"><input class="itext" type="text" id="testmail" name="testmail" value="" />
                    </td>
				</tr>
				<tr>
					<td colspan="2" class="cntr"><input type="hidden" id="action" name="action" value="biuletyn" />
                        <input type="submit" id="sendTest" class="button" value="Wyślij" />
				</tr>
			</table>
        </form>
    </div>
		<form action="/newsletter/admin/confirm" method="post" >
			<table id="tab_edit" cellspacing="0">
				...
				<tr>
					<td colspan="2" class="cntr"><input type="hidden" id="action" name="action" value="biuletyn" />
                        <input type="submit" id="submit" name="submit" class="button" value="Wyślij" />
                        <input type="button" id="wyslijTest" class="button" value="Wyślij testowy" />
				</tr>
			</table>
