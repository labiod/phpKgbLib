...
?>	
		<form name="promocje" action="/user/admin/confirm" method="post" enctype="multipart/form-data">
			<table id="tab_edit" cellspacing="0">
				...
				<tr>
					<td colspan="2" class="cntr">
						<a href="/user/admin" ><input type="button" id="redirect" name="redirect" class="button" value="Wróć" /></a>
