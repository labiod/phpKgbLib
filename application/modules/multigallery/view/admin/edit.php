...
<form name="multigallery" action="/multigallery/admin/confirm"
	...
	<input type="hidden" name="id"
		value="<?php echo $gall['id_gallery']; ?>" />
	<table id="tab_edit" cellspacing="0">
		...
		<tr>
			...
			<td class="right"><input type="text" name="g_name" class="itext"
				value="<?php echo $gall['name'];?>" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="right"><input type="file" id="photo" name="file" size="30" />
				<div id="up_photo" class="uploadImg">
						...
						<a href="/<?php echo $photo['path']; ?>" class="galeria" rel="g"><img
							src="/<?php echo $photo['path_mini'];?>" alt="foto" /></a> <input
							type='hidden' name='file_up[]'
							value="/<?php echo $photo['path'];?>" /><br /> <input
							id='photo_<?php echo $i;?>' type='button'
							style='margin-top: 5px;' class='remover button' value='Usuń' /> <input
							type='radio' name='main_photo'
							value="/<?php echo $photo['path'];?>"
							<?php if($main) echo "checked";?> /> zdjęcie główne
					</div>
							<?php
		...
		<tr>
			...
			<td class="right"><input name="visible" type="checkbox"
				class="iradio" <?php if($gall['visible']=="y") echo "checked";?> />
				widoczna</td>
		</tr>
		<tr>
			<td colspan="2" class="cntr"><a href="/multigallery/admin"><input
				...
				class="button" value="Zatwierdź" /></td>
		</tr>
	</table>
