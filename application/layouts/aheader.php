...
<script type="text/javascript"
	src="/public/js/fancybox/jquery.fancybox-1.3.4.js"></script>
<link type="text/css" rel="stylesheet"
	href="/public/js/fancybox/jquery.fancybox-1.3.4.css" />
...
?>
	<script src="/public/js/ajax/ajaxObject.js" language="Javascript"
	type="text/javascript"></script>
<script src="/public/js/ajax/getContent.js" language="Javascript"
	type="text/javascript"></script>
...
<body>
	...
	<div id="main">
		<div id="zalogowany">Jestes zalogowany jako  <?php echo $this->admin_name; ?> <a
				href="/auth/panel/logout">Wyloguj <img class="icon"
				src="<?php echo Settings::getParam("icon", "logout"); ?>"
				alt="Wyloguj" title="Wyloguj" /></a>
		</div>
	<?php
