...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Cze 2015, 23:59
...
INSERT INTO `categories` (`id`, `name`, `vehicle_type`) VALUES
(1, 'B', '1'),
(4, 'A', '2');
...
--
-- Struktura tabeli dla tabeli `vehicle_types`
--

CREATE TABLE IF NOT EXISTS `vehicle_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_polish_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Zrzut danych tabeli `vehicle_types`
--
