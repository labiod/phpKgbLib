...
class Utilities  {
	...
	static public function trimBody($text, $limit = 1000, $sep = "<p", $num = 3) {
		/*echo "tekst ma długość : ".strlen($text);
		echo "<br/>jego wersja bez znaczników ma długość : ".strlen(Utilities::clearHtmlTag($text));
		echo "<br />skrócony tekst to :".substr(Utilities::clearHtmlTag($text), 0, $limit);
		die();
		*/
		$trimmed = false;
		$index = 0;
